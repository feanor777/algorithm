...
@Service
public class LinearLogarithmicFunction implements FunctionCalculator, FunctionDescription {
  private static final String NAME = "linear logarithmic";
  ...
  public long apply(int param) {
    return param * Math.round((Math.log(param) / Math.log(BASE_2)));
  }
